...
while True:
    ...
    if len(lmList) != 0:
        ...
        # Line between thumb and first finger
    ...
    print(f"Current Volume Percentage: {int(volPer)} %")

    # Volume Bar and volume percentage
    cv2.rectangle(img, (50, 150), (85, 400), (255, 0, 0), 3)
    cv2.rectangle(img, (50, int(volBar)), (85, 400), (255, 0, 0), cv2.FILLED)
    cv2.putText(img, f'{int(volPer)} %', (40, 450),
                cv2.FONT_HERSHEY_COMPLEX, 1, (255, 0, 0), 3)

    # If volume is 100, Volume Bar and volume percentage will be in green
    if int(volPer) == 100:
    ...
    # If volume is 0, Volume Bar and volume percentage will be in red
    if int(volPer) == 0:
